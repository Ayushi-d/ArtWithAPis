package com.example.art_stationary.Fragments.CategoriesFragment;
...
import com.example.art_stationary.Fragments.CategoriesFragment.Presenter.CategoriesPresenter;
   ...
   @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // secondLevel.add(games);
        ...
        categoriesPresenter = new CategoriesPresenter(getActivity(),categoriesrecyclerview);
            ...
            try {
                if (resCode==200) {
                    ...
                    for (int i = 0; i < parentCategory.length(); i++) {
                        ...
                        expandedCategroryModel.setTitlear(data.optString("titlear"));
                        if (!data.isNull("subcategories")){
                            ...
                            for (int j =0; j < subCategory.length(); j++){
                                ...
                                subCategoryModel.setTitlear(subdata.optString("titlear"));
