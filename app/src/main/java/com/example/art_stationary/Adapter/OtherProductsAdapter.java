...
public class OtherProductsAdapter extends RecyclerView.Adapter<com.example.art_stationary.Adapter.OtherProductsAdapter.RecyclerViewHolder> {

        //private ArrayList<Mostpopularmodel> popularArrayList;
        private Context mcontext;
        private static com.example.art_stationary.Adapter.OtherProductsAdapter.ClickListener mOnClickListener;


        public OtherProductsAdapter( Context mcontext) {
        ...
        @NonNull
        @Override
        public com.example.art_stationary.Adapter.OtherProductsAdapter.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            // Inflate Layout
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.gridhomelist, parent, false);
            return new com.example.art_stationary.Adapter.OtherProductsAdapter.RecyclerViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull com.example.art_stationary.Adapter.OtherProductsAdapter.RecyclerViewHolder holder, int position) {
...
//                holder.tv_pricebook.setText(recyclerData.getPrice());
//            }
            holder.tv_bookname.setText("Multi Color Products");
            holder.tv_pricebook.setText("120.00 KWD");
        ...
        public void setOnItemClickListener(com.example.art_stationary.Adapter.OtherProductsAdapter.ClickListener clickListener) {
