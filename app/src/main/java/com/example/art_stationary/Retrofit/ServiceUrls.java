...
public class ServiceUrls {
    public static final String BASEURL= "http://kuwaitgate.com/artbookstore/webservices/";
    ...
    public static final String GETCATEGORIES= "artbookstore/categories";
    ...
    public static final String GETAREAS= "artbookstore/getareas";
    public static final String ADDADDRESS= "artbookstore/addaddress";
    public static final String MYADDRESS= "artbookstore/myaddresseslist";
